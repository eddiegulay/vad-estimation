...
from vad.export.onnx_export import run_onnx_streaming  # noqa: E402
...
def main(checkpoint_path: str, onnx_path: str) -> int:
...
if __name__ == "__main__":
    ...
    raise SystemExit(main(args.checkpoint, args.onnx))
